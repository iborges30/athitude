...
notificationsCount();setInterval(function(){notificationsCount()},1000*50);$(".notification_center").click(function(e){e.preventDefault();var notify=$(this).data("notify");var center=$(".notification_center_open");var centerList=$(".notification_center_list");$.post(notify,function(response){if(response.message){ajaxMessage(response.message,ajaxResponseBaseTime)}
...
if(this.files&&(this.files[0].type.match("image/jpeg")||this.files[0].type.match("image/png"))){var reader=new FileReader();reader.onload=function(e){target.fadeOut('fast',function(){$(this).attr('src',e.target.result).width('100%').fadeIn('fast')})};reader.readAsDataURL(this.files[0])}else{Trigger('<div class="trigger trigger_alert trigger_ajax"><b class="icon-warning">ERRO AO SELECIONAR:</b> O arquivo <b>'+this.files[0].name+'</b> não é válido! <b>Selecione uma imagem JPG ou PNG!</b></div>');target.fadeOut('fast',function(){$(this).attr('src',fileDefault).fadeIn('slow')});input.val('');return!1}});$(".jsc-brand").change(function(){var brand=$(this).val();if(brand==='new'){$('#new-brand').modal("show")}});$("form[name='formBrandproducts']").submit(function(){var dados=$(this).serialize();var url=$(this).attr("action");$.ajax({url:url,method:'post',dataType:'json',data:dados,beforeSend:function(){$(".csw-load").fadeIn("fast")},success:function(response){if(response.message=='error'){alert("Verifique o nome do fabricante. É possívelmente ela já existe no sistema.")}else{$("#new-brand").modal("hide");$(".jsc-brand").append("<option selected value='"+response.value+"'>"+response.name+"</option>")}},complete:function(){$(".csw-load").fadeOut("fast")}});return!1});$(".jsc-category").change(function(){var category=$(this).val();if(category==='category'){$('#new-category').modal("show")}});$("form[name='formCategoryProducts']").submit(function(){var dados=$(this).serialize();var url=$(this).attr("action");$.ajax({url:url,method:'post',dataType:'json',data:dados,beforeSend:function(){$(".csw-load").fadeIn("fast")},success:function(response){if(response.message=='error'){alert("Verifique o nome da categoria informada, possívelmente ela já existe no sistema.")}else{$("#new-category").modal("hide");$(".jsc-category").append("<option selected value='"+response.value+"'>"+response.name+"</option>")}},complete:function(){$(".csw-load").fadeOut("fast")}});return!1});$(".jsc-inventory-open-modal").click(function(){$("#new-inventory").modal("show");return!1});$("form[name='formInventory']").submit(function(){var dados=$(this).serialize();var url=$(this).attr("action");$.ajax({url:url,method:'post',dataType:'json',data:dados,beforeSend:function(){$(".csw-load").fadeIn("fast")},success:function(response){if(response.message){$(".ajax_response_modal").text("").fadeIn("fast").text(response.message)}
$(".jsc-table").append('<tr id="'+response.id+'"> <th scope="row">'+response.id+'</th> '+'    <td>'+response.size+'</td>'+'    <td class="text-white">'+'        <span class="btn btn-circle shadow" style="background:'+response.color+'"></span>'+'    </td>'+'    <td>'+response.size+'</td>'+'    <td>'+'        <a href="'+response.url.replace("delete","edit")+'" data-inventory-edit="'+response.id+'" class="btn btn-primary jsc-inventory-edit btn-circle btn-sm">'+'            <i class="fas fa-edit"></i>'+'        </a>'+'        <a data-delete-id="'+response.id+'" href="'+response.url+'" class="jsc-delete-inventory btn btn-danger btn-circle btn-sm">'+'            <i class="fas fa-trash"></i>'+'        </a>'+'    </td>'+'</tr>');$("form[name='formInventory']").resetForm()},complete:function(){$(".csw-load").fadeOut("fast")}});return!1});$("body").on("click",".jsc-delete-inventory",function(){var deleteId=$(this).data("delete-id");var url=$(this).attr("href");$.ajax({url:url,method:'post',data:{deleteId:deleteId},dataType:'json',success:function(response){if(response.detele){$("tr#"+response.id).fadeOut("fast")}}});return!1});$("body").on("click",".jsc-inventory-edit",function(){var inventoryId=$(this).data("inventory-edit");var url=$(this).attr("href");$.ajax({url:url,method:'post',data:{inventoryId:inventoryId},dataType:'html',success:function(response){$(".ajax-modal-edit-inventory").html(response);$("#update-inventory").modal("show")}});return!1});$(".container-fluid").on("submit",'form[name="formUpdateInvetory"]',function(){var dados=$(this).serialize();var url=$(this).attr("action");$.ajax({url:url,dataType:'json',data:dados,method:'post',beforeSend:function(){$(".csw-load").fadeIn("fast")},success:function(response){$("#update-inventory").modal("hide");location.reload()},complete:function(){$(".csw-load").fadeOut("fast")}});return!1});$('html').on('change','form[name="formGallery"]',function(e){e.preventDefault();e.stopPropagation();var form=$(this);var BASE='https://localhost/athitude';var url=$(this).attr("action");console.log(url);form.ajaxSubmit({url:url,dataType:'json',success:function(response){$.each(response.gallery,function(key,values){$(".ajax-gallery").append('  '+' <div class="mt-5 mb-5 m-lg-5" id="g-'+values.id+'">'+'  <a href="../gallery/delete/'+values.id+'" data-id=" '+values.id+' " data-image="'+values.uri+'" class="jsc-delete-image-gallery">'+'  <figure class="figure">'+'<img width="120" height="120" src="'+BASE+'/storage/'+values.uri+'">'+'    </figure>'+'    </a>'+'   </div>')})}})});$("body").on("click",".jsc-delete-image-gallery",function(){var id=$(this).data("id");var uri=$(this).attr("href");var image=$(this).data("image");var r=confirm("Você realmente deseja deletar essa imagem?");if(r==!0){$.ajax({url:uri,method:"Post",dataType:'json',data:{id:id,image:image},success:function(response){$("#g-"+response.image).slideUp("fast")}})}
return!1});$(".mask-date").mask('00/00/0000');$(".mask-datetime").mask('00/00/0000 00:00');$(".mask-month").mask('00/0000',{reverse:!0});$(".mask-doc").mask('000.000.000-00',{reverse:!0});$(".mask-card").mask('0000  0000  0000  0000',{reverse:!0});$(".mask-money").mask('000.000.000.000.000,00',{reverse:!0,placeholder:"0,00"})});tinyMCE.init({selector:"textarea.mce",language:'pt_BR',menubar:!1,theme:"modern",height:132,skin:'light',entity_encoding:"raw",theme_advanced_resizing:!0,plugins:["advlist autolink link image lists charmap print preview hr anchor pagebreak spellchecker","searchreplace wordcount visualblocks visualchars code fullscreen insertdatetime media nonbreaking","save table contextmenu directionality emoticons template paste textcolor media"],toolbar:"styleselect | pastetext | removeformat |  bold | italic | underline | strikethrough | bullist | numlist | alignleft | aligncenter | alignright |  link | unlink | fsphpimage | code | fullscreen",style_formats:[{title:'Normal',block:'p'},{title:'Titulo 3',block:'h3'},{title:'Titulo 4',block:'h4'},{title:'Titulo 5',block:'h5'},{title:'Código',block:'pre',classes:'brush: php;'}],link_class_list:[{title:'None',value:''},{title:'Blue CTA',value:'btn btn_cta_blue'},{title:'Green CTA',value:'btn btn_cta_green'},{title:'Yellow CTA',value:'btn btn_cta_yellow'},{title:'Red CTA',value:'btn btn_cta_red'}],setup:function(editor){editor.addButton('fsphpimage',{title:'Enviar Imagem',icon:'image',onclick:function(){$('.mce_upload').fadeIn(200,function(e){$("body").click(function(e){if($(e.target).attr("class")==="mce_upload"){$('.mce_upload').fadeOut(200)}})}).css("display","flex")}})},link_title:!1,target_list:!1,theme_advanced_blockformats:"h1,h2,h3,h4,h5,p,pre",media_dimensions:!1,media_poster:!1,media_alt_source:!1,media_embed:!1,extended_valid_elements:"a[href|target=_blank|rel|class]",imagemanager_insert_template:'<img src="{$url}" title="{$title}" alt="{$title}" />',image_dimensions:!1,relative_urls:!1,remove_script_host:!1,paste_as_text:!0});(function($){"use strict";$("#sidebarToggle, #sidebarToggleTop").on('click',function(e){$("body").toggleClass("sidebar-toggled");$(".sidebar").toggleClass("toggled");if($(".sidebar").hasClass("toggled")){$('.sidebar .collapse').collapse('hide')}});$(window).resize(function(){if($(window).width()<768){$('.sidebar .collapse').collapse('hide')}});$('body.fixed-nav .sidebar').on('mousewheel DOMMouseScroll wheel',function(e){if($(window).width()>768){var e0=e.originalEvent,delta=e0.wheelDelta||-e0.detail;this.scrollTop+=(delta<0?1:-1)*30;e.preventDefault()}});$(document).on('scroll',function(){var scrollDistance=$(this).scrollTop();if(scrollDistance>100){$('.scroll-to-top').fadeIn()}else{$('.scroll-to-top').fadeOut()}});$(document).on('click','a.scroll-to-top',function(e){var $anchor=$(this);$('html, body').stop().animate({scrollTop:($($anchor.attr('href')).offset().top)},1000,'easeInOutExpo');e.preventDefault()})})(jQuery);$("input:not(:checkbox),textarea,select").filter("[required]:visible").parent().find("label").addClass("required")